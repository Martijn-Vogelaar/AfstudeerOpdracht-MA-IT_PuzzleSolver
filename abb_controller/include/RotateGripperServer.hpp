...
protected:
    ...
    actionlib::SimpleActionServer<abb_controller_messages::RotateGripperAction> actionServer;


    abb_controller_messages::RotateGripperFeedback actionFeedback;
    abb_controller_messages::RotateGripperResult actionResult;
...
public:
     ...
     */
    void goalCallback(const abb_controller_messages::RotateGripperGoalConstPtr &goal);
};

...
protected:
    ...
    actionlib::SimpleActionServer<abb_controller_messages::MoveEndEffectorStraightNoRotationAction> actionServer;
    std::string actionName;
    abb_controller_messages::MoveEndEffectorStraightNoRotationFeedback actionFeedback;
    abb_controller_messages::MoveEndEffectorStraightNoRotationResult actionResult;
...
public:
     ...
     */
    void goalCallback(const abb_controller_messages::MoveEndEffectorStraightNoRotationGoalConstPtr &goal);
};
